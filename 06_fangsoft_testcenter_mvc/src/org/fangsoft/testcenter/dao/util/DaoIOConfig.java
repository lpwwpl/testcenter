...
public abstract class DaoIOConfig {
	...
	public static String getFileName(QuestionResult qr) {
		return qr.getClass().getSimpleName() + "-"
				+ qr.getQuestion().getName().hashCode() + SUFFIX;
	}
	public static String getFileName(TestResult tr) {
